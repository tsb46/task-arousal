...
fMRI preprocessing is performed on outputs from fMRIPrep for EuskalIBUR, and Precision
...
class PreprocessingPipeline:
    ...
    def write_out_fmri_file(
        self, fmri_img: nib.nifti1.Nifti1Image, file_orig: str
    ) -> None:
        """Write out the preprocessed fMRI file.
...
def func_pipeline(
    ...
    assert isinstance(func_img, nib.nifti1.Nifti1Image), (
        "Loaded fMRI data is not a Nifti1Image."
    )
...
def load_physio(
    dataset: str, physio_fp: str, physio_json: str | None
